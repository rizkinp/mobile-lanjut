...
import com.example.autentikasiapp.databinding.ActivitySignupBinding
                    ...
                    if (task.isSuccessful) {
                        ...
                        Toast.makeText(this,
                            "Berhasil mendaftarkan user, " +
                                    "silahkan cek email anda untuk verifikasi", Toast.LENGTH_LONG).show()
                        finish()
                    } else {
                        // Handle error and log error message
                        Log.e("SignUpActivity", "Gagal mendaftar: ${task.exception}")
                        Toast.makeText(this, "Tidak dapat mendaftar: ${task.exception?.message}",
